...
# NOTE: only "/" is listed. The session gate in lib/supabase/proxy.ts redirects
# every other path to /login for anonymous visitors, so no other route is
# reachable by a crawler today. Add the marketing and content routes here as
# they are opened up:
#   "/our-story|RideShareTahoe"
#   "/faq|Frequently"
#   "/safety|Safety"
#   "/community-guidelines|Community Guidelines"
#   "/tahoe-transportation|Tahoe"
#   "/rides/find|carpool"
