        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          ...
          <div className="text-center md:text-left">
            ...
            <div className="flex gap-4 mt-4 justify-center md:justify-start">
              <a
                href="https://www.linkedin.com/company/ridesharetahoe"
                target="_blank"
              ...
              <a
                href="https://www.instagram.com/ridesharetahoe/"
                target="_blank"
                rel="noopener noreferrer"
                className="text-slate-400 hover:text-white transition-colors"
              ...
              <a
                href="https://www.facebook.com/people/Ridesharetahoe/61585689170017/"
                target="_blank"
                rel="noopener noreferrer"
                className="text-slate-400 hover:text-white transition-colors"
                aria-label="Facebook"
              ...
              <a
                href="https://www.tiktok.com/@ridesharetahoe"
                target="_blank"
                rel="noopener noreferrer"
                className="text-slate-400 hover:text-white transition-colors"
                aria-label="TikTok"
